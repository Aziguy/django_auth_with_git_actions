...
def todo_list(request):
    ...
    return render(request, "todoapp/todo-list.html", context)
...
def create_todo(request):
    ...
    return render(request, 'todoapp/create-todo.html', context)
...
def todo_details(request, id):
    ...
    return render(request, 'todoapp/todo-details.html', context)
